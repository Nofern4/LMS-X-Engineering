...
import { X, Camera, User, GraduationCap, BookOpen, Building, Mail } from 'lucide-react';
              ...
              <div className="text-center">
                ...
                <div>
                  <button
                    type="button"
                    onClick={() => fileInputRef.current?.click()}
                    className="text-xs font-bold text-slate-700 hover:text-black underline inline-flex items-center gap-1 pt-1"
                  >
            ...
            <div className="flex-1 w-full space-y-3.5">
              ...
              <div className="pt-2 flex items-center justify-end">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-6 py-2 rounded-full bg-slate-900 hover:bg-black text-white text-xs font-bold shadow-md transition-colors"
                >
                  ปิดหน้าต่าง
                </button>
              </div>
